// Sizes Best for Display
    ...
    var hoop,
      ...
      function create() {
        ...
        var grd = bmd.context.createLinearGradient(0, 0, 0, game.height);
        grd.addColorStop(0, "#0171d5"); // Dark blue
        grd.addColorStop(1, "#89CFF0"); // Light blue
    
        bmd.context.fillStyle = grd;
        bmd.context.fillRect(0, 0, game.width, game.height);
      ...
      function createBall() {
        ...
        // ✅ Enable collision with the game world boundaries
        ball.body.collideWorldBounds = true;
        ball.body.restitution = 0.75; // Increase bounce effect
    
        // ✅ Ensure ball interacts properly with boundaries
        ball.body.velocity.x = 0; // Reset velocity before launch
        ball.body.velocity.y = 0; 
        ball.body.damping = 0.5; // Add damping for a more realistic bounce effect
    
        // Keep existing properties untouched
        ball.launched = false;
